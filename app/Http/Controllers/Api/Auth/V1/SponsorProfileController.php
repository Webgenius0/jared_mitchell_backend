...
class SponsorProfileController extends Controller
{
    ...
    /**
     * Store (Create/Initialize) Sponsor Profile
     */
    public function store(Request $request)
    {
        try {
            ...
            return $this->success(
                ...
                new UserResource($user->refresh()->load('profile'))
            );

        } catch (Exception $e) {
            DB::rollBack();
            Log::error('Sponsor profile store error: ' . $e->getMessage());
            return $this->error(
    ...
    public function update(Request $request)
    {
        try {
            ...
            DB::rollBack();
            Log::error('Sponsor profile update error: ' . $e->getMessage());
            return $this->error(
                ['exception' => $e->getMessage()],
