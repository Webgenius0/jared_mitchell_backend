...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 2. Define 6 Verified Shopify Products
        $productsData = [
            [
                ...
                'is_featured'       => true,
                'is_active'         => true,
                'thumbnail'         => 'https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?q=80&w=800&auto=format&fit=crop',
            ...
            [
                ...
                'is_featured'       => true,
                'is_active'         => true,
                'thumbnail'         => 'https://images.unsplash.com/photo-1580481072645-022f9a6d8310?q=80&w=800&auto=format&fit=crop',
            ...
            [
                ...
                'is_featured'       => true,
                'is_active'         => true,
                'thumbnail'         => 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?q=80&w=800&auto=format&fit=crop',
        ...
        // 3. Seed Products and Product Images
        foreach ($productsData as $data) {
            ...
            // Re-seed gallery images for the product
