<div class="app-menu navbar-menu">
    <div class="navbar-brand-box">
        ...
        <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ asset('admin/assets/images/default/logo.png') }}" alt="" height="22">
            </span>
            <span class="logo-lg">
    ...
    <div class="dropdown sidebar-user m-1 rounded">
        <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown"
            ...
            <span class="d-flex align-items-center gap-2">
                <img class="rounded header-profile-user" src="{{ asset('admin/assets/images/default/user.jpg') }}"
                    alt="Header Avatar">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-apps-2-line"></i> <span data-key="t-apps">Messaging</span>
                    </a>
                ...
                <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-pages">CMS</span>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-settings-5-line"></i> <span data-key="t-base-ui">System Settings</span>
                    </a>
                    <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                        <div class="row">
                            <div class="col-lg-4">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.profile.index') }}" class="nav-link" data-key="t-alerts">Profile Settings</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-badges.html" class="nav-link" data-key="t-badges">General Settings</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-buttons.html" class="nav-link" data-key="t-buttons">Contact Settings</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-colors.html" class="nav-link" data-key="t-colors">Logo Settings</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-cards.html" class="nav-link" data-key="t-cards">Social Settings</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-carousel.html" class="nav-link"
                                            data-key="t-carousel">Maintenance Setting</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-dropdowns.html" class="nav-link"
                                            data-key="t-dropdowns">Stripe Settings</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-grid.html" class="nav-link" data-key="t-grid">Mail Settings</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
