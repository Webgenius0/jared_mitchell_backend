            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Business Categories</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('show.admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('admin.business-spotlights.index') }}">Business
                                        Spotlights</a></li>
                ...
                <form id="categoryForm">
                    <div class="modal-body px-4 py-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="categoryDescription" rows="4" placeholder="Write short description..."></textarea>
                        </div>
    ...
    <script>
        (function() {
            ...
            const table = $('#categoriesTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.business-categories.data') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            window.resetForm = function() {
                ...
                document.getElementById('modalTitle').innerText = 'Add Business Category';
            ...
            categoryForm.addEventListener('submit', function(e) {
                ...
                const url    = id ? `{{ url('/business-categories') }}/${id}` :
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Alert.confirm('This will permanently delete the category.', {
                    ...
                    if (!confirmed) return;
                    axios.delete(`{{ url('/business-categories') }}/${id}`)
                        .then(res => {
                            Toast.success(res.data.message);
                            table.draw(false);
                        })
