                ...
                <div class="row">
                    <div class="col-lg-8">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-3">
                                                        <div class="mb-2">
                                                            ...
                                                            <select name="event_media[0][type]" class="form-select media-type-select" required>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="mb-2">
                                                            ...
                                                            <input type="file" name="event_media[0][file]" class="form-control media-file-input" required accept="image/*">
                                                        </div>
                                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">Ticket Tiers <span class="text-danger">*</span>
                                    </h5>
                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" name="ticket_tiers[0][name]" class="form-control"
                                                        required placeholder="e.g. Early Bird">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="mb-2">
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="number" step="0.01" name="ticket_tiers[0][service_fee]"
                            ...
                            <div class="card-body">
                                <div class="mb-3 text-center">
                                    ...
                                    <div class="position-relative d-inline-block">
                                        <div class="position-absolute top-100 start-100 translate-middle">
                                            <label for="cover_image" class="mb-0" data-bs-toggle="tooltip"
                                                data-bs-placement="right" title="Select Cover Image">
                                                <div class="avatar-xs">
                                                    <div
                                            ...
                                            <input class="form-control d-none" id="cover_image" name="cover_image"
                                                type="file" accept="image/png, image/gif, image/jpeg">
                                        </div>
                                        <div class="avatar-lg bg-light rounded shadow">
                                            <img src="{{ asset('admin/assets/images/default/no-img.png') }}"
                                                id="cover_image_preview" class="avatar-lg rounded object-fit-cover">
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ends_at') is-invalid @enderror"
                                        id="ends_at" name="ends_at" value="{{ old('ends_at') }}" data-provider="flatpickr"
                                        data-date-format="Y-m-d" data-enable-time="true" placeholder="Select date and time"
                                        required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="event_type" id="event_type" required>
                                        ...
                                        <option value="pop_up" {{ old('event_type') == 'pop_up' ? 'selected' : '' }}>Pop-Up
                                        </option>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch form-switch-md">
                                        <input class="form-check-input" type="checkbox" id="is_spotlight_eligible"
                                            name="is_spotlight_eligible" {{ old('is_spotlight_eligible') ? 'checked' : '' }}>
