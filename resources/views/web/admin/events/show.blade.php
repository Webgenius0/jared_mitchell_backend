                                    ...
                                    <select disabled id="artist-select" class="form-select">
                                        ...
                                        @foreach($artists as $artist)
                                            <option value="{{ $artist->id }}" 
                                                ...
                                                data-image="{{ $artist->profile?->avatar_url ?? asset('admin/assets/images/users/user-dummy-img.jpg') }}">
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-3 artist-card-item">
                                        <div class="card border shadow-none mb-0">
                                            <div class="card-body text-center p-3">
                                                ...
                                                <img src="{{ $assignedArtist->profile?->avatar_url ?? asset('admin/assets/images/users/user-dummy-img.jpg') }}" alt="" class="rounded-circle avatar-md mb-2 object-fit-cover" style="width: 64px; height: 64px;">
