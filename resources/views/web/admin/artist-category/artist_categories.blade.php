                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.artist-spotlights.index') }}">Artist
                                        Spotlights</a></li>
    ...
    <script>
        (function() {
            ...
            categoryForm.addEventListener('submit', function(e) {
                ...
                const url = id ? `{{ url('/artist-categories') }}/${id}` :
                    `{{ route('admin.artist-categories.store') }}`;
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Alert.confirm('This will permanently delete the category.', {
                    ...
                    if (!confirmed) return;
                    axios.delete(`{{ url('/artist-categories') }}/${id}`)
                        .then(res => {
                            Toast.success(res.data.message);
                            table.draw(false);
                        })
