<div class="accordion custom-accordionwithicon custom-accordion-border accordion-border-box"
    ...
    <div class="accordion-item card mb-3">
        ...
        <div id="collapseHero" class="accordion-collapse collapse show" aria-labelledby="headingHero"
            data-bs-parent="#artistSpotlightAccordion">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="title" class="form-control" rows="2"
                                placeholder="Enter hero title">{{ $hero?->title }}</textarea>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Hero Description</label>
                            <textarea name="sub_title" class="form-control" rows="3"
                                placeholder="Enter hero description">{{ $hero?->sub_title }}</textarea>
                        </div>
                        <div class="col-md-12">
                            ...
                            @if($hero?->image)
                                <div class="mt-2">
                                    <img src="{{ asset($hero->image) }}" alt="Hero Background" class="rounded border"
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $list?->title }}"
                                placeholder="e.g. Discover More Artists">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Section Subtitle</label>
                            <textarea name="sub_title" class="form-control" rows="3"
                                placeholder="Enter section description">{{ $list?->sub_title }}</textarea>
                        </div>
                        <div class="col-12 text-end mt-4">
    ...
    <div class="accordion-item card mb-3">
        <h2 class="accordion-header" id="headingHighlights">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                <i class="ri-star-line me-2"></i> Celebrating Artist Spotlight winers
            </button>
        </h2>
                ...
                <form id="highlightsForm">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label class="form-label">Section Subtitle</label>
                            <textarea name="sub_title" class="form-control" rows="3"
                                placeholder="Enter section description">{{ $highlights?->sub_title }}</textarea>
                        </div>
                        <div class="col-12 text-end mt-4">
    ...
    <div class="accordion-item card mb-3">
        <h2 class="accordion-header" id="headingLadder">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#collapseLadder" aria-expanded="false" aria-controls="collapseLadder">
                <i class="ri-bar-chart-line me-2"></i> Weekly Artist Spotlight Ladder
            </button>
        </h2>
        <div id="collapseLadder" class="accordion-collapse collapse" aria-labelledby="headingLadder"
            data-bs-parent="#artistSpotlightAccordion">
            <div class="accordion-body">
                <form id="ladderForm">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label">Section Title</label>
                            <input type="text" name="title" class="form-control" value="{{ $ladder?->title }}"
                                placeholder="e.g. Weekly Spotlight Ladder">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Section Subtitle</label>
                            <textarea name="sub_title" class="form-control" rows="3"
                                placeholder="Enter section description">{{ $ladder?->sub_title }}</textarea>
                        </div>
                        <div class="col-12 text-end mt-4">
                ...
                <form id="joinForm">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label">Section Title</label>
                            <textarea name="title" class="form-control" rows="2"
                                placeholder="e.g. Become part of a growing network...">{{ $join?->title }}</textarea>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Section Subtitle</label>
                            <textarea name="sub_title" class="form-control" rows="2"
                                placeholder="Enter optional subtitle">{{ $join?->sub_title }}</textarea>
                        </div>
                        <div class="col-12 text-end mt-4">
    ...
    {{-- Interview Section --}}
    <!-- @php $interview = $cmsData->get('artist_spotlight_interview'); @endphp
    <div class="accordion-item card mb-3">
        <h2 class="accordion-header" id="headingInterview">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#collapseInterview" aria-expanded="false" aria-controls="collapseInterview">
                <i class="ri-mic-line me-2"></i> Artist Interview Section
            </button>
        </h2>
        <div id="collapseInterview" class="accordion-collapse collapse" aria-labelledby="headingInterview"
            data-bs-parent="#artistSpotlightAccordion">
            <div class="accordion-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $interview?->title }}"
                                placeholder="e.g. Behind the Creative Journey">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Main Subtitle</label>
                            <textarea name="sub_title" class="form-control" rows="2"
                                placeholder="Enter main subtitle">{{ $interview?->sub_title }}</textarea>
                        </div>
                        <hr>
                        <div class="col-md-12">
                            <label class="form-label">Card Title</label>
                            <input type="text" name="card_title" class="form-control"
                                value="{{ $interview?->metadata['card_title'] ?? '' }}"
                                placeholder="e.g. Artist Interview: Behind the Creative Journey">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Card Description (Rich Text)</label>
                            <div id="interviewEditor" class="snow-editor" style="height: 250px;"></div>
                            <input type="hidden" id="interviewDescription" name="description"
                        ...
                        <div class="col-md-12">
                            ...
                            @if($interview?->image)
                                <div class="mt-2">
                                    <img src="{{ asset($interview->image) }}" alt="Interview Thumbnail"
    ...
    <div class="accordion-item card mb-3">
        <h2 class="accordion-header" id="headingWhyExists">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#collapseWhyExists" aria-expanded="false" aria-controls="collapseWhyExists">
                <i class="ri-question-line me-2"></i> Why OSI Exists Section
            </button>
        </h2>
        <div id="collapseWhyExists" class="accordion-collapse collapse" aria-labelledby="headingWhyExists"
            data-bs-parent="#artistSpotlightAccordion">
            <div class="accordion-body">
                <form id="whyExistsForm">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label">Section Title</label>
                            <input type="text" name="title" class="form-control" value="{{ $whyExists?->title }}"
                                placeholder="e.g. Why OSI Exists">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Section Description</label>
                            <textarea name="description" class="form-control" rows="4"
                                placeholder="Enter section description">{{ $whyExists?->sub_title }}</textarea>
                        </div>
                        <div class="col-12 text-end mt-4">
...
@push('scripts')
    <script>
        $(function () {
            ...
            if (editorEl) {
                interviewEditor = Quill.find(editorEl);
                if (interviewEditor && descInput.value) {
                    interviewEditor.clipboard.dangerouslyPasteHTML(descInput.value);
                }
                if (interviewEditor) {
                    interviewEditor.on('text-change', function () {
                        descInput.value = interviewEditor.getSemanticHTML();
                    });
                }
            }
