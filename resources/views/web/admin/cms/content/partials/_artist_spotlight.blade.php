<div class="accordion custom-accordionwithicon custom-accordion-border accordion-border-box" id="artistSpotlightAccordion">
    ...
    <div class="accordion-item card mb-3">
        ...
        <div id="collapseInterview" class="accordion-collapse collapse" aria-labelledby="headingInterview" data-bs-parent="#artistSpotlightAccordion">
            <div class="accordion-body">
                <form id="interviewForm" enctype="multipart/form-data">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="card_title" class="form-control" value="{{ $interview?->metadata['card_title'] ?? '' }}" placeholder="e.g. Artist Interview: Behind the Creative Journey">
                        </div>
                        <div class="col-md-12">
