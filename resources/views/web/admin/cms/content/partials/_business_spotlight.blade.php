<div class="accordion custom-accordionwithicon custom-accordion-border accordion-border-box"
    ...
    <div class="accordion-item card mb-3">
        ...
        <div id="collapseHero" class="accordion-collapse collapse show" aria-labelledby="headingHero"
            data-bs-parent="#businessSpotlightAccordion">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $list?->title }}"
                                placeholder="e.g. Discover More Business">
                        </div>
                        <div class="col-md-12">
    ...
    <div class="accordion-item card mb-3">
        <h2 class="accordion-header" id="headingPicks">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#collapsePicks" aria-expanded="false" aria-controls="collapsePicks">
                <i class="ri-thumb-up-line me-2"></i> Weekly Business Spotlight Ladder
            </button>
        </h2>
        <div id="collapsePicks" class="accordion-collapse collapse" aria-labelledby="headingPicks"
            data-bs-parent="#businessSpotlightAccordion">
            <div class="accordion-body">
                <form id="picksForm">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label">Section Title</label>
                            <input type="text" name="title" class="form-control" value="{{ $picks?->title }}"
                                placeholder="e.g. Editor's Picks">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Section Subtitle</label>
                            <textarea name="sub_title" class="form-control" rows="3"
                                placeholder="Enter section description">{{ $picks?->sub_title }}</textarea>
                        </div>
                        <div class="col-12 text-end mt-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $ladder?->title }}"
                                placeholder="e.g. OSI Spotlight Ladder">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Section Subtitle</label>
                            <textarea name="sub_title" class="form-control" rows="3"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="card_title" class="form-control"
                                ...
                                placeholder="e.g. Business Interview: Behind the Creative Journey">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            @if($interview?->image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $interview->image) }}" alt="Interview Thumbnail"
                                        class="rounded border" style="max-height: 150px;">
                                </div>
                            @endif
                        </div>
