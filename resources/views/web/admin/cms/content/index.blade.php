            ...
            <div class="col-lg-9">
                <div class="accordion" id="cmsAccordion">
                    ...
                    <div class="accordion-item card mb-3">
                        ...
                        <div id="collapseShop" class="accordion-collapse collapse" aria-labelledby="headingShop" data-bs-parent="#cmsAccordion">
                            <div class="accordion-body">
                                <form id="shopForm">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label class="form-label">Section Title</label>
                                            <input type="text" name="title" class="form-control" value="{{ $shop?->title }}" placeholder="e.g. Shop OSI Apparel, Ebooks, and Digital">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Section Subtitle</label>
                                            <textarea name="sub_title" class="form-control" rows="3" placeholder="Enter section subtitle">{{ $shop?->sub_title }}</textarea>
                                        </div>
                                        <div class="col-12 text-end mt-4">
                    ...
                    <div class="accordion-item card mb-3">
                        <h2 class="accordion-header" id="headingCta">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCta" aria-expanded="false" aria-controls="collapseCta">
                                <i class="ri-megaphone-line me-2"></i> Footer CTA Section
                            </button>
                        </h2>
                        <div id="collapseCta" class="accordion-collapse collapse" aria-labelledby="headingCta" data-bs-parent="#cmsAccordion">
                            <div class="accordion-body">
                                <form id="ctaForm">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label class="form-label">CTA Title</label>
                                            <input type="text" name="title" class="form-control" value="{{ $cta?->title }}" placeholder="e.g. Ready to grow your business?">
                                        </div>
                                        <div class="col-12 text-end mt-4">
                    ...
                    <div class="accordion-item card mb-3">
                        ...
                        <div id="collapseNewsletter" class="accordion-collapse collapse" aria-labelledby="headingNewsletter" data-bs-parent="#cmsAccordion">
                            <div class="accordion-body">
                                <form id="newsletterForm">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label class="form-label">Newsletter Title</label>
                                            <input type="text" name="title" class="form-control" value="{{ $newsletter?->title }}" placeholder="e.g. Stay inspired. Get the latest spotlights...">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Newsletter Subtitle</label>
                                            <textarea name="sub_title" class="form-control" rows="3" placeholder="Enter newsletter subtitle">{{ $newsletter?->sub_title }}</textarea>
                                        </div>
                                        <div class="col-12 text-end mt-4">
