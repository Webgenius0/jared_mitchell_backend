                        ...
                        <form id="editPermissionForm">
                            <div class="mb-3">
                                ...
                                <small class="text-muted">
                                    Use lowercase format: <code>action resource</code> (e.g., <code>view users</code>)
                                </small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-2 bg-light" id="namePreview">
                                    <span class="badge bg-light text-body fs-12">{{ $permission->name }}</span>
                                </div>
                            </div>
...
(function($) {
    ...
    $(document).on('submit', '#editPermissionForm', function(e) {
        ...
        axios.post('{{ route("admin.permissions.update", $permission) }}', formData)
            .then(function(res) {
            ...
            .finally(function() {
                $btn.prop('disabled', false)
                    .html('<i class="ri-save-line me-1"></i> Update Permission');
            });
    });
